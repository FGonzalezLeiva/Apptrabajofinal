                                ...
                                <div className="blog-details-inner">
                                    <article className="single-post-details">
                                        <div className="post-thumbnail">
                                            <img className="w-100"
                                                 src={require('../assets/images/blog/blog-big-2.jpg').default}
                                                 alt="Blog Images"/>
                                        </div>
                                        ...
                                        <div className="post-thumbnail mt--50">
                                            <img className="w-100"
                                                 src={require('../assets/images/blog/blog-big-1.jpg').default}
                                                 alt="Blog Images"/>
                                        </div>
                                        <div className="content mt--50">
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                        ...
                                        <div className="inner">
                                            ...
                                            <div className="commnent-list-wrap mt--25">
                                                ...
                                                <div className="comment">
                                                    <div className="thumb">
                                                        <img src={require('../assets/images/blog/team-01.jpg').default}
                                                             alt="Multipurpose"/>
                                                    </div>
                                                ...
                                                <div className="comment comment-reply">
                                                    <div className="thumb">
                                                        <img src={require('../assets/images/blog/team-02.jpg').default}
                                                             alt="Multipurpose"/>
                                                    </div>
                                                    <div className="content">
                                                        <div className="info d-flex justify-content-between">
                                                ...
                                                <div className="comment">
                                                    <div className="thumb">
                                                        <img src={require('../assets/images/blog/team-03.jpg').default} alt="Multipurpose"/>
                                                    </div>
                                                    <div className="content">
                                                        <div className="info d-flex justify-content-between">
