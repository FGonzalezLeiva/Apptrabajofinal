...
class Demo extends Component {
    render() {
        ...
        let features = [
            {
                ...
                featureDescription: 'Latest React v17.x.x used'
            },
            {
                featureIconName: 'icon-mobile',
                featureTitle: 'Responsive Design',
                featureDescription: 'Castro is supper responsive & work perfectly in all devices.'
            },
            {
                featureIconName: 'icon-profile-male',
                featureTitle: 'User Friendly',
                featureDescription: 'Castro easy to use for any technical & nontechnical People.'
            },
            {
            ...
            },
            {
                ...
                featureDescription: 'It comes with most popular FontAwesome, Ionicon and Flaticon icon font.'
            },
            {
                featureIconName: 'icon-puzzle',
                featureTitle: 'Google Font',
                featureDescription: '600+ Google Fonts. You can change font for all elements easily.'
            },
            {
        ...
        let suggestionsHTML = [
            {
                imgUrl: '//s3.envato.com/files/186369241/preview.__large_preview.png',
                suggestionLink: '//themeforest.net/item/apnew-multipurpose-landing-page-template/16154013?ref=AslamHasib',
                suggestionTitle: 'Apnew - Multipurpose Landing Page Template'
            },

            {
                imgUrl: '//s3.envato.com/files/223832857/preview.__large_preview.jpg',
                suggestionLink: '//themeforest.net/item/appro-multipurpose-landing-page-template/19718075?ref=AslamHasib',
                suggestionTitle: 'Appro – Multipurpose Landing Page Template'
            },

            {
                imgUrl: '//s3.envato.com/files/255284479/01_preview_sotare.__large_preview.png',
                suggestionLink: '//themeforest.net/item/sotare-software-landing-page-bootstrap-4-template/22688830?ref=AslamHasib',
                suggestionTitle: 'Sotare - Software Landing Page Bootstrap 4 Template'
            }
        ];
        ...
        let suggestionsWP = [
            ...
            {
                imgUrl: '//s3.envato.com/files/219991401/preview.__large_preview.jpg',
                suggestionLink: '//themeforest.net/item/apptech-wordpress-landing-page-theme/19323624?ref=AslamHasib',
                suggestionTitle: 'AppTech - WordPress Landing Page Theme'
            },

            {
                imgUrl: '//s3.envato.com/files/239072226/preview.__large_preview.png',
                suggestionLink: '//themeforest.net/item/tuco-construction-building-wordpress-theme/21192136?ref=AslamHasib',
...

            {
                ...
                suggestionLink: '//themeforest.net/item/shield-roofing-service-wordpress-theme/19837552?ref=AslamHasib',
                        ...
                        <div className="container">
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="logo col-6 text-start position-relative">
                                    <a href="/">
                                        <img src={require('../assets/images/landing/logo.png').default}
                                             className="img-fluid" alt="torres"/>
                                        <img src={require('../assets/images/landing/logo-2.png').default} alt="torres"
